...
public class Health : MonoBehaviour
{
    ...
    [Tooltip("Health restored after respawn. Health pickups can raise this when collected at full health.")]
    public int defaultHealth = 1;

    [Tooltip("Maximum current health. If a Health pickup is collected while full, this value increases.")]
    public int maximumHealth = 1;

    [Tooltip("Current in-game health value.")]
    ...
    public void TakeDamage(int damageAmount)
    {
        ...
        PlayerPowerUpController powerUpController = GetComponent<PlayerPowerUpController>();

        if (powerUpController && powerUpController.TryConsumeShield())
        {
            return;
        }
    ...
    public void ReceiveHealing(int healingAmount)
    {
        ...
        {
            maximumHealth += healingAmount;
            defaultHealth = Mathf.Max(defaultHealth, maximumHealth);
